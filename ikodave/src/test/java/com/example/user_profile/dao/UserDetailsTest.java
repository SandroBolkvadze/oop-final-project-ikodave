...
import com.example.user_profile.dao.MySQLUserDetails;
import com.example.user_profile.dao.UserDetails;
...
class UserProfileDaoTest {
    ...
    void testGetStatusProblemsCount() {
        ...
        int count = dao.getStatusProblemsCount(user, status);
    ...
    void testReturnsZeroIfNoMatches() {
        User user = new User();
        user.setId(1);
        Status status = new Status(999, "NON_EXISTENT");
